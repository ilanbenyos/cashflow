        ...
        <table id="tablebank" class="table table-hover" cellpadding="0" cellspacing="0">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><a class="grey-icon edit_user" href="<?= base_url('configuration/bank/update/'.$row->BankId)?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a> <a class="grey-icon del_bank" href="javascript:void(0);" onclick="myFunction(<?php echo $row->BankId;?>);"><i class="fa fa-trash-o" aria-hidden="true"></i></a></td>
            </tr>
            <?php }?>
          </tbody>
        </table>
