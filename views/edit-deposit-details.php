                  ...
                  <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12 common-border-box">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                      <div class="form-group">
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-12">
                          <input type="text" class="form-control xyz" name="plamtReceived" id="plamtReceived" value="<?php echo number_format($allPspIncome->PlannedAmt) ?>" onkeypress="javascript:return isNumber(event)" placeholder="Planned Processed Amount"  />
                        </div>
                      </div>
                    </div>
                    <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                      <div class="form-group">
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-12">
                          <input type="text" class="form-control xyz" name="plcommval" id="plcommval" value="<?php echo number_format($allPspIncome->PlannedComP) ?>" onkeypress="javascript:return isNumber(event)">
                        </div>
                      </div>
                    </div>
                    <div class="col-md-12 col-sm-12 col-xs-12">
                      <div class="form-group">
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-12">
                          <input type="text" class="form-control xyz" name="plamtval" id="plamtval" value="<?php echo number_format($allPspIncome->PlannedCom) ?>" onkeypress="javascript:return isNumber(event)">
                        </div>
                      </div>
                    </div>
                    <!-- <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                      <div class="form-group">
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-12 xyz">
                          <input type="text" class="form-control" name="plnetAmt" id="plnetAmt" placeholder="Planned Net Amount" value="<?php echo number_format($allPspIncome->PlannedNetAmt) ?>" />
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12 common-border-box">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                      <div class="form-group">
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-12">
                          <input type="text" class="form-control xyz" name="acamtReceive" id="acamtReceive" value="<?php echo number_format($allPspIncome->ActualAmt) ?>" onkeypress="javascript:return isNumber(event)" placeholder="Actual Processed Amount"  />
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                      <div class="form-group">
                        <label class="col-md-4 col-sm-4 col-xs-12">Commission %</label>
                        <div class="col-md-8 col-sm-8 col-xs-12">
                          <input type="text" class="form-control xyz" name="accommval" id="accommval" value="<?php echo number_format($allPspIncome->ActualComP) ?>" onkeypress="javascript:return isNumber(event)">
                        </div>
                      </div>
                    </div>
                    <div class="col-md-12 col-sm-12 col-xs-12">
                      <div class="form-group">
                        <label class="col-md-4 col-sm-4 col-xs-12">Commission Amount</label>
                        <div class="col-md-8 col-sm-8 col-xs-12">
                          <input type="text" class="form-control xyz" name="acamtval" id="acamtval" value="<?php echo number_format($allPspIncome->ActualCom) ?>"  onkeypress="javascript:return isNumber(event)">
                        </div>
                      </div>
                    </div>
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-12">
                          <input type="hidden" name="crrComm" id="crrComm">
                           <?php if ($crrData->isCRR == 0 && $crrData->CRRId == $allPspIncome->TransId ) { ?>
                             <input type="text" class="form-control xyz" name="crrAmt" id="crrAmt" value="<?php echo number_format($crrData->PlannedAmt); ?>" placeholder="CRR Amount" readonly/>
                          <?php  }else { ?> 
                          <input type="text" class="form-control xyz" name="crrAmt" id="crrAmt" value="<?php echo number_format($allPspIncome->PlannedAmt); ?>" placeholder="CRR Amount" readonly/>
                        <?php } ?>
                        </div>
                      </div>
                    </div>
                   <?php  } ?>
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                      <div class="form-group">
                        <label class="col-md-4 col-sm-4 col-xs-12">Net Amount</label>
                        <div class="col-md-8 col-sm-8 col-xs-12">
                          <input type="text" class="form-control xyz" name="acnetAmt" id="acnetAmt" placeholder="Actual Net Amount" value="<?php echo number_format($allPspIncome->ActualNetAmt) ?>" />
