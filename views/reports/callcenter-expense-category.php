...
<div class="white-bg">
  <div class="row">
    <div class="col-md-12 inline-divs row-flex align">
      <div class="col-lg-5 col-md-4 col-sm-12 col-xs-12 inline-divs text-left no-padding"><strong>This report will show call center wise expenses group by category</strong></div>
