...
<nav class="navbar navbar-inverse" id="sidebar">
  <ul class="sidebar-menu">
    ...
    <li class="psp-income"><a href="#"><i class="fa fa-download" aria-hidden="true"></i> <span>PSP Income</span></a></li>
    <?php 
        foreach ($callCenter as $value) { ?>
          <li class="callCenterExp"><a href="#"><i class="fa"><img class="call-centre-icon img-responsive" src="<?= base_url('assets/images/callcenter-expenses.png')?>"></i><span>Call Center Expenses</span></a></li>
        <?php }
        ?>
    
    <li class="expenses"><a href="#"><i  class="fa fa-briefcase"  aria-hidden="true"></i> <span>Expenses</span></a></li>
    <li class="bankTrans"><a href="#"><i class="fa fa-clock-o" aria-hidden="true"></i> <span>Bank Transaction</span></a></li>
    ...
    <?php }else if(isset($_SESSION['logged_in']) && ($_SESSION['logged_in'] === true) && ($_SESSION['user_role'] == "CEO")){?>
      ...
      <li class="callCenter"><a href=""><i class="fa fa-briefcase" aria-hidden="true"></i> <span>Call Center Expenses</span></a></li>
      <?php  } ?>
  </ul>
</nav>