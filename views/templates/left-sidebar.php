...
<nav id="sidebar">
    <ul class="sidebar-menu list-unstyled components">
      <li> <a href="#ConSubmenu" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"><i class="fa fa-desktop" aria-hidden="true"></i> <span>Configuration</span></a>
        <ul class="collapse list-unstyled" id="ConSubmenu" data-parent="#sidebar">
      ...
      <li> <a href="#ReportSubmenu" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"><i class="fa fa-file-text-o" aria-hidden="true"></i> <span>Reports</span></a>
        <ul class="collapse list-unstyled" id="ReportSubmenu" data-parent="#sidebar">
